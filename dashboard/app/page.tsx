...
export default function OverviewPage() {
  ...
  // Compute breakdown stats from decisions
  ...
  return (
    <div className="flex-1 pb-12">
      <Header
        ...
        subtitle="Monitors automated recovery decisions, ML calibration scores, policy guardrails, and financial impact."
        onRefresh={fetchData}
      />
      ...
      <div className="p-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <KpiCard
            ...
            subtitle="Percentage of retry interventions that resulted in recovery"
        ...
        {/* Decision Engine Architecture Flow */}
        <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-xs">
          <div className="flex items-center justify-between mb-4 border-b border-slate-100 pb-3">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">
                How failed payments progress from ML probability scoring to policy guardrails and financial impact
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-7 gap-3 text-center">
            <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg">
              ...
              <div className="text-xs font-bold text-slate-800 mt-1">Failed Payment</div>
            </div>
            ...
            <div className="p-3 bg-sky-50 border border-sky-200 rounded-lg">
              <div className="text-[10px] font-bold text-sky-600 uppercase">2. ML Score</div>
              <div className="text-xs font-bold text-sky-950 mt-1">P(recovery) = 0.8188</div>
            </div>
            ...
            <div className="p-3 bg-purple-50 border border-purple-200 rounded-lg">
              <div className="text-[10px] font-bold text-purple-600 uppercase">3. EV Math</div>
              <div className="text-xs font-bold text-purple-950 mt-1">ERV &gt; ₹0.00</div>
            </div>
            ...
            <div className="p-3 bg-emerald-50 border border-emerald-200 rounded-lg">
              <div className="text-[10px] font-bold text-emerald-600 uppercase">4. Action</div>
              <div className="text-xs font-bold text-emerald-950 mt-1">RETRY / ESCALATE</div>
            </div>
          </div>
        </div>

        {/* 2-Column Grid: Decision Breakdown & Baseline Comparison */}
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-xs flex flex-col justify-between">
            <div>
              ...
              <p className="text-xs text-slate-500 mb-4">
                Comparing Net Recovery Value against naive operational baselines
              </p>
            ...
            <div className="mt-4 pt-3 border-t border-slate-100 text-xs text-slate-500">
              <span className="font-semibold text-slate-700">Economic Takeaway:</span> Due to low ₹15 fee scale, Decision Engine achieves <span className="font-semibold text-emerald-600">93.02% revenue capture</span> while eliminating wasted retries on unrecoverable fraud & blocked cards.
            </div>
          </div>
        </div>
      </div>
